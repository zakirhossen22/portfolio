   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-6 text-center">
            <a href="<?php the_field('cta_btn_url','option');?>" class="box-btn"><?php the_field('cta_btn','option');?><i class="fa fa-angle-double-right"></i></a>
         </div>
      </div>
   </div>
</section>
      ...
      <div class="row">
         ...
         <div class="col-lg-3 col-md-6">
            <div class="single-footer contact-box">
               <h4><?php the_field('footer_conatct_title','option');?></h4>
               <ul>
               <?php
